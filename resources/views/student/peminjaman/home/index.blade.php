        ...
        <div class="2xl:container 2xl:mx-auto lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-8 gap-6">
                ...
                <div class="p-6 bg-gray-50">
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600 my-4">Silahkan mengisi form untuk melakukan
                        peminjaman</p>
                    <a href="peminjaman/create"
                        class="cursor-pointer text-base leading-4 font-medium text-gray-800 border-b-2 border-gray-800 hover:text-gray-600">Akses
                        Disini</a>
                </div>
                ...
                <div class="p-6 bg-gray-50">
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600 my-4">Cek status surat peminjaman lab anda
                        disini</p>
                    <a href="peminjaman/status"
                        class="cursor-pointer text-base leading-4 font-medium text-gray-800 border-b-2 border-gray-800 hover:text-gray-600">Akses
                        Disini</a>
                </div>
