        ...
        <div class="sm:flex items-center justify-between w-full sm:px-24 pt-6">
            <div class="sm:block flex w-full items-center">
                <div
                    ...
                    <div class="w-4 h-4 @if ($data->status_id >= 1) bg-indigo-700 @else bg-gray-800 @endif
                    ...
                    <div class="w-4 h-4 @if ($data->status_id >= 2) bg-indigo-700 @else bg-gray-800 @endif dark:bg-gray-100 rounded flex items-center justify-center md:ml-8 lg:ml-20">
                        @if ($data->status_id >= 2)
                        <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/card33-svg1.svg"
                            alt="check" />
                    ...
                    <div class="w-4 h-4 @if ($data->status_id >= 3) bg-indigo-700 @else bg-gray-800 @endif rounded flex items-center justify-center md:ml-8 lg:ml-20">
                        @if ($data->status_id >= 3)
                        <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/card33-svg1.svg"
                            alt="check" />
                    ...
                    <div class="w-4 h-4 @if ($data->status_id === 4) bg-indigo-700 @else bg-gray-800 @endif dark:bg-gray-400 rounded flex items-center justify-center md:ml-8 lg:ml-20">
                    </div>
                </div>
        ...
        <div class="pt-4 px-12 sm:block hidden">
            <div class="flex items-center justify-between">
                <div class="flex flex-col items-center">
                    <a tabindex="0" class="focus:outline-none pb-4  cursor-pointer focus:underline focus:text-gray-500 hover:text-gray-400 text-sm font-medium leading-4  @if ($data->status_id === 1) text-gray-800
                ...
                <div class="flex flex-col items-center pl-10 md:pl-8 lg:pl-20">
                    <a tabindex="0" class="focus:outline-none pb-4 cursor-pointer focus:underline focus:text-gray-500 hover:text-gray-400 text-sm font-medium leading-4  @if ($data->status_id >= 2) text-indigo-800
                ...
                <div class="flex flex-col items-center pl-10 md:pl-8 lg:pl-20">
                    <a tabindex="0" class="focus:outline-none pb-4 cursor-pointer focus:underline focus:text-gray-500 hover:text-gray-400 text-sm font-medium leading-4 @if ($data->status_id >= 3) text-indigo-800
                ...
                <div class="flex flex-col items-center pl-10 md:pl-8 lg:pl-20">
                    <a tabindex="0" class="focus:outline-none  pb-4 cursor-pointer focus:underline focus:text-gray-500 hover:text-gray-400 text-sm font-medium leading-4 @if ($data->status_id === 4) text-indigo-800
