    ...
    <div class="max-w-7xl py-6 px-4 sm:px-2 lg:px-8 bg-white dark:bg-gray-800">
        <div class="sm:flex items-center justify-between">
            <div class="sm:mb-0 mb-4 flex items-center">
                ...
                <a tabindex="0"
                    class="focus:text-gray-500 hover:text-gray-500 focus:underline focus:outline-none cursor-pointer  text-xl pl-4 font-semibold leading-5 text-gray-800 dark:text-gray-100">Antonin
                    Hafer</a>
            </div>
