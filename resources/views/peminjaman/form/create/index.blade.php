                    ...
                    <div class="bg-white rounded shadow mt-7 py-7">
                        ...
                        <div class="mt-10 px-7">
                            ...
                            <form action="{{ url('peminjaman') }}" method="post">
                                ...
                                <div class="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7 ">
                                    ...
                                    <div>
                                        <p class="text-base font-medium leading-none text-gray-800">Tanggal Awal Peminjaman</p>
                                        <input type="date"
                                            class="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50"
                                    ...
                                    <div>
                                        <p class="text-base font-medium leading-none text-gray-800">Tanggal Akhir Peminjaman</p>
                                        <input type="date"
                                            class="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50"
                        ...
                        <div class="pt-6 border-gray-300 mt-2 px-7">
                            ...
                            <div class="mt-10 border border-gray-300 rounded">
                                <textarea name="judul_penelitian" class="resize-none w-full h-[100px] px-4 py-4 text-base outline-none text-slate-600"
                                    placeholder="Start typing here ..."> </textarea>
                            </div>
                        </div>
                        <div class="mt-10 px-7">
                            <p class="text-base font-medium leading-none text-gray-800">No Surat</p>
                            <input name="no_surat" class="w-1/2 p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50" type="text" disabled value="{{ str_replace('-','',\Carbon\Carbon::now()->toDateString()).rand(10,100) }}">
                        </div>
