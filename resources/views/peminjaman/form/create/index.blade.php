        ...
        <div class="row mt-3">
            <form action="/peminjaman" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local"  class="form-control  @error('tanggal_awal_peminjaman') is-invalid @enderror" name="tanggal_awal_peminjaman" value={{ old('tanggal_awal_peminjaman') }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control" name="tanggal_akhir_peminjaman"  value={{ old('tanggal_akhir_peminjaman') }}>
                </div>
